...
import mernTshirt from './Assets/images/hinhWeb/mernTshirt.png';
import mernTshirtFull from './Assets/images/fullScreen/mernTshirt.png';
import socialMui from './Assets/images/hinhWeb/social-mui.png';
import socialMuiFull from './Assets/images/fullScreen/social-mui.png';
import basketballProfile from './Assets/images/hinhWeb/basketball-profile.png';
import basketballProfileFull from './Assets/images/fullScreen/basketball-profile.png';
import nitendo from './Assets/images/hinhWeb/32Nitendo.png';
import nitendoFull from './Assets/images/fullScreen/32NitendoFull.png';
...
const product = [
  {
    id: 32,
    duAn: 'Nitendo',
    congNghe: 'ReactJS, React Router, Tailwindcss, React Slick',
    image: nitendo,
    imageDetail: nitendoFull,
    ngonNgu: NAME_REACT,
    linkDemo: 'https://nitendo-clone.netlify.app',
    moTa: 'Sử dụng Reactjs và tailwindcss clone lại giao diện Nitendo.',
  },
  {
    id: 29,
    duAn: 'Shop T-shirt',
    congNghe:
      'Reactjs, Redux-Toolkit, NodeJS, Express, Mongoose, Heroku, Netlify, Stripe Payment',
    image: mernTshirt,
    imageDetail: mernTshirtFull,
    ngonNgu: NAME_REACT,
    linkDemo: 'https://tshirtdev.netlify.app',
    moTa: 'Xây dựng API với Nodejs, Express, Mongoose, Stripe, sử dụng ReactJS làm giao diện người dùng, sử dụng Heroku và Netlify deploy website.',
  },
  ...
  {
    id: 31,
    duAn: 'Basketball Profile',
    congNghe: 'ReactJS, Tailwindcss,  Framer-motion, Formik, Export image',
    image: basketballProfile,
    imageDetail: basketballProfileFull,
    ngonNgu: NAME_REACT,
    linkDemo: 'https://basketball-profile.web.app',
    moTa: 'Người dùng có thể thay đổi thông tin, các theme tùy chọn và tải xuống hình ảnh background profile của mình.',
  },
  {
    id: 30,
    duAn: 'Social Mui',
    ...
    image: socialMui,
    imageDetail: socialMuiFull,
    ngonNgu: NAME_REACT,
    linkDemo: 'https://social-mui.netlify.app',
    moTa: 'Sử dụng framework Material UI và ReactJS xây dựng giao diện.',
  },
  {
    id: 28,
    duAn: 'MERN LEARN',
  ...
  },
  {
    ...
    duAn: 'Cinema',
    congNghe:
      'Reactjs, Redux, Axios, Restful API, AOS Animation, Formik, Material UI',
